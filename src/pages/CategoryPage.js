...
//                   <h3>{product.name}</h3>
//                   {/* <p>Gene: {product.gender}&nbsp; • &nbsp;Age: {product.age}</p> */}
//                   <p>Gene: <b>{product.gender}</b> &nbsp; • &nbsp; Age: <b>{product.age}</b></p>
//                   <h3>{product.price}</h3>
//                 </div>
//               ))}
//             </div>
...
//       setFilteredProducts(productsData); // Show all products if no gender is selected
//     } else {
...
//         <div className="category-page">
//           <div className="filter-section">
//             <FilterSidebar onGenderChange={handleGenderChange} />
//           </div>
//           <div className="product-section">
//             <div className="product-section-header">
//               <h1>Dogs</h1><h4>{filteredProducts.length} puppies</h4> {/* Display the filtered count */}
//             </div>  
//             <div className="product-grid">
